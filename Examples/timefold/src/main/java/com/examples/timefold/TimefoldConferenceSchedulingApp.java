...
import com.examples.timefold.persistence.RoomRepository;
import com.examples.timefold.persistence.SessionRepository;
import com.examples.timefold.persistence.TimeslotRepository;
...
public class TimefoldConferenceSchedulingApp {

    public static void main(String[] args) {
        SpringApplication.run(TimefoldConferenceSchedulingApp.class, args);
    }
